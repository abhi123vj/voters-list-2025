...
const App: React.FC = () => {
  ...
  const listInfo = [
    {
      name: "G02053-Mayyanad",
      id: "G02053",
      wards: [
        {
          name: "G02053021 - VENPALAKKARA",
          id: "021",
          pollingStations: [
            {
              name: "001 - KANICHERRY L P S SOUTH SIDE, MANNANIKULAM",
              id: "001",
            },
            {
              name: "002 - KANICHERRY L P S NORTH SIDE, MANNANIKULAM",
              id: "002",
            },
          ],
        },
        ...
        {
          name: "G02053022 - KIZHAKKEPADANILAM",
          id: "022",
          pollingStations: [
            {
              name: "001 - GRACE INTERNATIONAL SCHOOL EAST SIDE, VAZHAPPALLY",
              id: "001",
            },
            {
              name: "002 - GRACE INTERNATIONAL SCHOOL WEST SIDE, VAZHAPPALLY",
              id: "002",
            },
          ],
        },
        {
          name: "G02053024 - PINAYKKAL",
          id: "024",
          pollingStations: [
            {
              name: "001 - MUTHODAM AUDITORIUM SOUTH SIDE, PINAYKKAL",
              id: "001",
            },
            {
              name: "002 - MUTHODAM AUDITORIUM NORTH SIDE, PINAYKKAL",
              id: "002",
            },
          ],
        },
  ...
  const localBodies = listInfo.map((lb) => ({
    id: lb.id,
    name: lb.name,
  }));

  const wardsForSelected =
    listInfo
      .find((lb) => lb.id === localBody)
      ?.wards.map((w) => ({ id: w.id, name: w.name })) || [];

  const pollingForSelected =
    listInfo
      .find((lb) => lb.id === localBody)
      ?.wards.find((w) => w.id === ward)
      ?.pollingStations.map((p) => ({ id: p.id, name: p.name })) || [];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow px-4 py-4 mb-4 md:mb-6">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            {/* Ward */}
            <div>
              <label className="text-sm text-gray-700 font-medium">Ward</label>
              <select
                className="mt-1 border rounded-lg px-3 py-2 w-full text-sm"
                value={ward}
                onChange={(e) => setWard(e.target.value)}
              >
                {wardsForSelected.map((w) => (
